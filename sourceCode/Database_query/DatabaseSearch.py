...
def chooseexp(cnx,p_value,e_value,All_experiments,exp_List,Overview,bg_toshow,RetestExportPath,checkNames=[],checkVar=[],checkVarPath=[],
              info_logo=0):
...
#                    print checkVarPath[varindex].get()
    ...
    #                        print exporline
                        ...
                        xmlWriter_ElementTree.makePSIMIXMLFile(ExportList["NewHits Found"],exportfilePath,baitName)
                    else:
...
#            Gui_looks.create_window(checkbox=True,checknames=checkNames,checkVar=checkVar,checkvarpath=checkVarPath,information=info_logo,buttoncommand=export)
        ...
        root.geometry("%dx%d+%d+%d" % (1000, 500, 600, 500))
        ...
        Gui_looks.CreateLabels(root,[ExportInformation.prey,ExportInformation.bait,ExportInformation.molecule,
                ...
                ExportInformation.AspecificNotFound,ExportInformation.RawDataInfo,ExportInformation.CytoscapeInputFile,
